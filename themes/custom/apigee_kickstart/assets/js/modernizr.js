...
!function (e, t, n) {
  ...
  function i() {
    ...
    for (var a in w) if (w.hasOwnProperty(a)) {
      if (e = [], t = w[a], t.name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length)) for (n = 0; n < t.options.aliases.length; n++) e.push(t.options.aliases[n].toLowerCase());
      for (i = r(t.fn, "function") ? t.fn() : t.fn, o = 0; o < e.length; o++) s = e[o], l = s.split("."), 1 === l.length ? Modernizr[l[0]] = i : (!Modernizr[l[0]] || Modernizr[l[0]] instanceof Boolean || (Modernizr[l[0]] = new Boolean(Modernizr[l[0]])), Modernizr[l[0]][l[1]] = i), _.push((i ? "" : "no-") + l.join("-"));
    }
  }
  function o(e) {
    var t = T.className,
  ...
  function s(e, t) {
    if ("object" == _typeof(e)) for (var n in e) x(e, n) && s(n, e[n]);else {
      e = e.toLowerCase();
      var r = e.split("."),
        i = Modernizr[r[0]];
  ...
  function u(e, n, r, i) {
    var o,
      ...
      d = l("div"),
      p = a();
    if (parseInt(r, 10)) for (; r--;) u = l("div"), u.id = i ? i[r] : c + (r + 1), d.appendChild(u);
  ...
  function d(e, t, n) {
    var i;
    for (var o in e) if (e[o] in t) return n === !1 ? e[o] : (i = t[e[o]], r(i, "function") ? c(i, n || t) : i);
    return !1;
  }
  function p(e) {
  ...
  function g(e, t, i, o) {
    ...
    for (var u, c, d, m, h, g = ["modernizr", "tspan", "samp"]; !q.style && g.length;) u = !0, q.modElem = l(g.shift()), q.style = q.modElem.style;
    for (d = e.length, c = 0; d > c; c++) if (m = e[c], h = q.style[m], f(m, "-") && (m = p(m)), q.style[m] !== n) {
